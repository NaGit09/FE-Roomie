...
export default function RegisterPage() {
  return (
    <div className="min-h-screen w-full flex bg-background selection:bg-primary/20">
      {/* Left side - Registration Form Wrapper */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12 bg-background order-2 lg:order-1 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(193,68,14,0.03),transparent)] pointer-events-none" />
        <div className="w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-4 duration-700 relative z-10">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-muted order-1 lg:order-2">
        <Image
          src="/rental-room-bg.png"
          alt="Cozy rental room"
          fill
          className="object-cover transition-transform duration-700 hover:scale-105 transform scale-x-[-1]"
          priority
          sizes="50vw"
        />
        ...
        <div className="absolute z-10 text-white p-16 text-left max-w-xl bottom-0">
          <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-primary/20 text-primary-foreground border border-primary/20 backdrop-blur-md mb-6">
            <Sparkles className="w-3.5 h-3.5 mr-2" /> Join our community
          </div>
          <h1 className="text-6xl font-bold mb-6 tracking-tight leading-[1.1]">
            Elevate your <br />
            <span className="text-primary italic">living</span> standard.
          </h1>
          <p className="text-xl text-zinc-300 max-w-md leading-relaxed">
            Join thousands of others who have found their dream spaces through
            our platform. Experience the best rental service.
          </p>
        </div>
      </div>
    </div>
