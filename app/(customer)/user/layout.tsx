...
import {
  User, Heart, History, Coins, Settings, LogOut, ShieldCheck
} from "lucide-react";
    ...
    return (
      <div className="mx-auto max-w-7xl px-4 py-32 flex justify-center items-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-semibold text-slate-400">Đang kiểm tra bảo mật...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-slate-50/50 min-h-[calc(100vh-68px)]">
      <div className="w-full px-4 py-8 sm:px-6 lg:px-10 max-w-none">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[280px_1fr]">
          ...
          {/* ── Left Sidebar ── */}
          <aside className="flex flex-col justify-between rounded-3xl border border-slate-100 bg-white p-6 shadow-sm md:sticky md:top-[92px] md:h-[calc(100vh-140px)] md:min-h-[560px]">
            ...
            <div className="mt-8 border-t border-slate-50 pt-5 space-y-1">
              ...
              <Link
                ...
                `}
              >
                <Settings className={`h-4 w-4 shrink-0 ${pathname === "/user/setting" ? "text-primary" : "text-slate-400"}`} />
                Cài đặt tài khoản
              </Link>
