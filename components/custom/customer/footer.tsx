        ...
        <div className="lg:col-span-2 flex flex-col gap-5">
          ...
          >
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[10px] font-medium text-other-2 tracking-widest uppercase">
                Find your space
              </span>
            </div>
          </Link>
          ...
          <p className="text-sm leading-relaxed text-other-2 max-w-xs">
            Discover premium rental rooms tailored to your lifestyle — from cozy
            studios to spacious shared apartments across the city.
          </p>
