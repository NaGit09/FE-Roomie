          ...
          <div className="flex items-center gap-2">
            {isAuthenticated && user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-60 mt-1.5 rounded-[1.5rem] border-slate-100 p-2 shadow-xl"
                >
                  {/* Custom Header Info */}
                  ...
                  <DropdownMenuItem
                    asChild
                    className="rounded-xl px-3 py-2 cursor-pointer text-slate-600 hover:text-slate-900 transition-colors"
                  >
              ...
              <>
                <Button
                  asChild
                  size="sm"
                  className="h-9 px-4.5 text-xs font-black tracking-widest uppercase rounded-full bg-primary hover:bg-primary/95 text-white cursor-pointer shadow-md shadow-primary/10 hover:scale-[1.02] transition-all"
                >
          ...
          {!isAuthenticated && (
            <div className="pt-2 border-t border-other-4 flex gap-2">
              <Button
                asChild
                size="sm"
                className="flex-1 h-9 rounded-full text-xs font-black tracking-wider uppercase bg-primary text-white"
              >
